...
// ──────────────────────────────────────────────
// Product: Espressif ESP32-S3-DevKitC-1
// Chip:    ESP32-S3 (dual-core Xtensa LX7, 240MHz)
// Flash:   8MB  |  PSRAM: 2MB
// USB:     Native USB-C (no UART bridge needed)
// ──────────────────────────────────────────────

// ── Pin Assignments ─────────────────────────────
//
//  ESP32-S3 Pin    Sensor              Notes
//  ───────────     ──────              ─────
//  GPIO4           Soil Moisture AOUT  ADC1_CH3
//  GPIO5           DS18B20 DATA        OneWire, 4.7k pull-up to 3.3V
//  GPIO8           I2C SDA             BH1750 + BME280 (shared bus)
//  GPIO9           I2C SCL             BH1750 + BME280 (shared bus)
//  GPIO2           Status LED          Onboard
//
#define PIN_SOIL_MOISTURE   4
